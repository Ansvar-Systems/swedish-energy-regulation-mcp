...
When running locally via `npx @ansvar/swedish-energy-regulation-mcp`, all database queries stay on your machine. The only external data flow is between the MCP client and the AI provider (e.g., Anthropic).
...
For privacy questions: https://github.com/Ansvar-Systems/swedish-energy-regulation-mcp/issues
